                ...
                <div className="control-structure">
                    ...
                    <div className="controlRGB light-blue controles-box">
                        <div className="btn-control-box">
                            ...
                            <input className="input-control" id="text2" type="text" defaultValue="" onChange={(e) => this.props.text(e)} />
                        </div>
                        <div className="text-control bottom">
                            <div className="text-control-inside">
                        ...
                        <div className="text-control">
                            <div className="text-control-inside">
                                ...
                                <input id="textSize2" className="text-size-control" type="text" defaultValue="20" onChange={(e) => this.props.text(e)} />
                            </div>
                            <div className="text-control-inside">
                    ...
                    <div className="controlRGB light-blue controles-box">
                        <div className="btn-control-box">
                            ...
                            <input className="input-control" id="text3" type="text" defaultValue="" onChange={(e) => this.props.text(e)} />
                        </div>
                        <div className="text-control bottom">
                            <div className="text-control-inside">
                        ...
                        <div className="text-control">
                            <div className="text-control-inside">
                                ...
                                <input id="textSize3" className="text-size-control" type="text" defaultValue="20" onChange={(e) => this.props.text(e)} />
                            </div>
                            <div className="text-control-inside">
